...
class _HomeState extends State<Home> {
  ...
  Widget _list_item({title, url}) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 10.0),
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0),color: Colors.accents[Random().nextInt(8)]),
        margin: EdgeInsets.symmetric(horizontal: 5.0),
